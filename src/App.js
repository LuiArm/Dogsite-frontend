...
function App() {
  // URL in a variable 
  const url = "https://dogs-backend-la.herokuapp.com"

  // State to hold the list of dogs
  const [dogs, setDogs] = React.useState([])

  // create variable Empty dog for the Create Form 
  const emptyDog = {
    name: "",
    age: 0,
    img: ""
  ...
  // handleUpdate - function for when the edit form is sumbitted 
